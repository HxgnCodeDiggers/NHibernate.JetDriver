...
namespace NHibernate.JetDriver.Tests.TransformFromClauseBehaviour
{
    ...
    {
        private object _Id;
        private readonly ISet<CatalogCategoriesEntity> _ChildrenCategories = new LinkedHashSet<CatalogCategoriesEntity>();
        private readonly ISet<CatalogEntriesEntity> _CatalogEntries = new LinkedHashSet<CatalogEntriesEntity>();
